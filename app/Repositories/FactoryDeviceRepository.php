...
class FactoryDeviceRepository
{
    ...
    public function getFactoryDevicesQuery()
    {
        $ips = Ip::select([
            'IP'
        ])->get();
        ...
        $query = License::query()->select([
            ...
            'factory_clients.name as ClientName'
        ])
            ->from('licenses as l')
            ->leftJoin($this->pingback . '.requests as pb', 'l.GroupId', '=', 'pb.GroupIdLicense')
            ->leftJoin('factory_clients', 'l.Client', '=', 'factory_clients.id')
    ...
    public function getFactorySearchFilteredDevicesQuery($filters)
    {


        $query = $this->getFactoryDevicesQuery();
        if ($filters) {
    ...
    public function getFactorySimpleDevicesQuery()
    {
        $ips = Ip::select([
            'IP'
        ])->get();
    ...
    public function getFactoryFilteredDevicesQuery($GroupId, $MachineId, $filters)
    {
    ...
    public function updateDevice($params)
    {
        ...
        try {
            ...
            if ($result instanceof License) {
                ...
                if (isset($params["CustomizedQR"]) && !empty($params["CustomizedQR"])) {
                    $newValues["CustomizedQR"] = $params["CustomizedQR"];
                } else {
                    $newValues["CustomizedQR"] = null;
                }
                if (isset($params["MachineSerialNumber"])) {
                    $newValues["MachineSerialNumber"] = $params["MachineSerialNumber"];
                }
                if (isset($params["ClientNumber"])) {
                    $newValues["ClientNumber"] = $params["ClientNumber"];
                }
                if (isset($params["Client"])) {
                    $newValues["Client"] = $params["Client"];
                }
                if (isset($params["ProductDefinition"])) {
                    $newValues["ProductDefinition"] = $params["ProductDefinition"];
                }

...
class PdfController extends Controller
{
    ...
    public function generateColorBookPdf($excelFile = null)
    {
        ...
        try {
            ...
            $layout = [
                'width' => 29.7, // A4 width in cm
                'height' => 21, // A4 height in cm
                'verso' => [
                    'margin' => 0.5
                ]
            ];
            ...
            $pdf = Pdf::loadView('pdf.colorbook', $data);

            // Configurar opciones para manejar correctamente UTF-8
    ...
    public function generateColorBookPdfCarta($excelFile = null)
    {
        ini_set('max_execution_time', '1500');
        set_time_limit(60 * 25);
        try {
            ...
            $layoutA4 = [
                ...
                'verso' => [
                    ...
                    'text-margin' => 0.5,
                    'primary-font-size' => 2.5,
                    'secondary-font-size' => 2,
                ],
                'recto' => [
                    'margin' => 0.5,
                    'image-margin' => 0.25,
                    'font-size' => 8,
                    'font-size-correction' => 1,
                    'text-y-percentage' => 0.2
                ]
            ];
            $layoutLetter = [
                'width' => 21.59,
            ...
            //  return response()->json(['success' => true, 'data' => $data]);
            //   $pdf = Pdf::loadView('pdf.colorbook', $data);
            $pdf = Pdf::loadView('pdf.colorbook_carta', $data)

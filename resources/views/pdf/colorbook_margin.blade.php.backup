...
<body style="margin: 0cm 0cm;height:100%;">
    <x-styled-div fontFamily="'NotoSerif'" width="{{ $width }}cm" height="{{ $height }}cm" top="{{ $layout['margin-out'] }}cm" left="{{ $layout['margin-in'] }}cm" margin="0cm 0cm" overflow="hidden" position="relative">
    ...
    <x-styled-div fontFamily="'NotoSerif'" fontSize="{{ $layout['page2']['text-font-size'] }}cm" lineHeight="{{ $layout['page2']['text-font-size'] }}cm" width="{{ $width }}cm" height="{{ $height }}cm" top="{{ $layout['margin-out'] }}cm" left="{{ $layout['margin-in'] }}cm" margin="0cm 0cm" overflow="hidden" position="relative">
    ...
    <div style="page-break-after: always;"></div>
    <x-styled-div backgroundImage="{{ $layout['page4']['image'] ?? '' }}" backgroundSize="cover" backgroundPosition="center" width="{{ $width }}cm" height="{{ $height }}cm" top="{{ $layout['margin-out'] }}cm" left="{{ $layout['margin-in'] }}cm" margin="0cm 0cm" overflow="hidden" position="relative">
    </x-styled-div>

    <div style="page-break-after: always;"></div>
    <x-styled-div fontFamily="'NotoSerif'" backgroundImage="{{ $layout['page5']['image'] ?? '' }}" backgroundSize="cover" backgroundPosition="center" width="{{ $width }}cm" height="{{ $height }}cm" top="{{ $layout['margin-out'] }}cm" left="{{ $layout['margin-in'] }}cm" margin="0cm 0cm" overflow="hidden" position="relative">
    ...
    <x-styled-div width="{{ $width }}cm" height="{{ $height }}cm" top="{{ $layout['margin-out'] }}cm" left="{{ $layout['margin-in'] }}cm" backgroundColor="black" margin="0cm 0cm" overflow="hidden" position="relative">
        ...
        <x-styled-div position="absolute" width="{{ $versoMainLayerWidth }}cm" left="{{ $versoMainLayerMargin }}cm" top="{{ $versoText1Top }}cm" lineHeight="{{ $layout['verso']['primary-font-size'] }}cm" fontSize="{{ $layout['verso']['primary-font-size'] }}cm" color="white" fontFamily="{{ \App\Services\FontMappingService::mapHardcodedToFamily("'NotoSerif'") }}" textAlign="center">
            {!! \App\Services\FontMappingService::convertQuillToPDF(htmlspecialchars_decode($item['es'] ?? '', ENT_QUOTES)) !!}
        </x-styled-div>

        <x-styled-div position="absolute" width="{{ $versoMainLayerWidth }}cm" left="{{ $versoMainLayerMargin }}cm" top="{{ $versoText2Top }}cm" lineHeight="{{ $layout['verso']['secondary-font-size'] }}cm" fontSize="{{ $layout['verso']['secondary-font-size'] }}cm" color="white" fontFamily="{{ \App\Services\FontMappingService::mapHardcodedToFamily("'NotoSerifItalic'") }}" textAlign="center">
            {!! \App\Services\FontMappingService::convertQuillToPDF(htmlspecialchars_decode($item['sy2'] ?? '', ENT_QUOTES)) !!}
        </x-styled-div>
    </x-styled-div>

    <x-styled-div width="{{ $width }}cm" height="{{ $height }}cm" top="{{ $layout['margin-out'] }}cm" left="{{ $layout['margin-in'] }}cm" margin="0cm 0cm" overflow="hidden" position="relative">
        ...
        <x-styled-div position="absolute" width="{{ $rectoImageLayerWidth }}cm" left="{{ $rectoImageLayerMargin }}cm" top="{{ $rectoTextTop }}cm" fontSize="{{ $layout['recto']['font-size'] }}cm" lineHeight="{{ $layout['recto']['font-size'] }}cm" color="black" fontFamily="{{ \App\Services\FontMappingService::mapHardcodedToFamily("'Zen'") }}" textAlign="center" transform="translate(-0.1cm, -0.1cm)">
            {{ $item['sym'] ?? '' }}
        </x-styled-div>
        ...
        <x-styled-div position="absolute" width="{{ $rectoImageLayerWidth }}cm" left="{{ $rectoImageLayerMargin }}cm" top="{{ $rectoTextTop }}cm" fontSize="{{ $layout['recto']['font-size'] }}cm" lineHeight="{{ $layout['recto']['font-size'] }}cm" color="white" fontFamily="{{ \App\Services\FontMappingService::mapHardcodedToFamily("'Zen'") }}" textAlign="center">
            {{ $item['sym'] ?? '' }}
        </x-styled-div>
    </x-styled-div>
